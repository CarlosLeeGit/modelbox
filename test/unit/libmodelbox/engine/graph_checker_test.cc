...
TEST_F(GraphCheckerTest, ConditionNotMatch1) {
  auto conf_file_value =
      R"(
        digraph demo {
          a[type=flowunit, flowunit=test_0_2, device=cpu, deviceid=0] 
...
TEST_F(GraphCheckerTest, ConditionNotMatch2) {
  auto conf_file_value =
      R"(
        digraph demo {
          a[type=flowunit, flowunit=test_0_1, device=cpu, deviceid=0] 
...
TEST_F(GraphCheckerTest, ConditionAddition1) {
  auto conf_file_value =
      R"(
        digraph demo {
          a[type=flowunit, flowunit=test_0_1, device=cpu, deviceid=0] 
...
TEST_F(GraphCheckerTest, ConditionAddition2) {
  auto conf_file_value =
      R"(
        digraph demo {
          a[type=flowunit, flowunit=test_0_1, device=cpu, deviceid=0] 
